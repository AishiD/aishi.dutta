    ...
    <div className="flex flex-col min-h-fit font-bold justify-center items-center text-sm mb-40">
      <div className="w-fit lg:w-10/12 p-6 mb-8 rounded-2xl shadow-lg backdrop-blur-md bg-purple-100">
        ...
        <a
          ...
          className="block w-1/2 p-1 text-white bg-purple-800 mx-auto mb-5 text-center rounded-lg shadow-[8px_8px_10px_#bcc4c6,-8px_-8px_10px_#ffffff] active:shadow-[inset_8px_8px_10px_#bcc4c6,inset_-8px_-8px_10px_#ffffff] active:scale-95"
        >
          {linkText}
        </a>
      </div>
